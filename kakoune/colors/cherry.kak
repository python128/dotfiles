...
declare-option str bg 'rgb:23232F'
...
declare-option str psel 'rgb:3c3c50'
declare-option str ssel 'rgb:353746'

declare-option str background %opt{bg}
...
set-face global operator "%opt{aqua}+b"
...
set-face global comment "%opt{azure}+i"
set-face global docstring "%opt{azure}+i"
...
set-face global LineNumberCursor "%opt{psel},%opt{black}+b"
